        ...
        fetch(url)
            ...
            .then((data1) => {
                ...
                if (len > 0) {
                    ...
                    fetch("https://youtube.googleapis.com/youtube/v3/search?channelId=UCHHYAjTRDFv9T59yhLbpVcA&eventType=live&type=video&key=AIzaSyBG0wbSgmzZRT4bEYO7lhgrna5hm3_S24o")
                        .then(response => response.json())
                        .then((data2) => {
                            const id = data2.items[0].id.videoId;
                            document.getElementById('str').src = paste.concat(id)
